# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="d0f90-101">完了したプロジェクトを実行する方法</span><span class="sxs-lookup"><span data-stu-id="d0f90-101">How to run the completed project</span></span>
